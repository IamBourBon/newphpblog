                        ...
                        <div class="panel-heading">
                            ...
                            <div class="col-md-10">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <?php echo $row['v_comment_author_email']." " ?><i class="fa fa-pencil"></i>
                                        </div>
                                                    ...
                                                    <form method="POST" action="">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input type="hidden" name="comment_id" value="<?php echo $row['n_blog_comment_id'] ?>">
