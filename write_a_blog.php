...
<body onload="menuActive()">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="blogs.php" role="form" method="POST" enctype="multipart/form-data" >
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="Write_Blog" value="1">
                                        </div>

                                        <button type="submit" class="btn btn-success">Write a Blog</button>
                                    </form>
                                </div>
                            </div>
                            <!-- /.row (nested) -->
    ...
    <script>
        document.forms[0].addEventListener('submit',function(event){
            var file_main = document.getElementById('main_image').files[0];
            var file_alt = document.getElementById('alt_image').files[0];

            //size of file upload limit 20MB 
            if(file_main.size > 20971520 || file_alt.size > 20971520) 
            {
